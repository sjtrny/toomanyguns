...
for index, row in unique_nsw_postcodes.iterrows():
    ...
    print(
        f"{unique_nsw_postcodes.index.get_loc(index)/len(unique_nsw_postcodes)*100:.2f}% completed"
    )
...
df_2017.to_csv("assets/firearms_2017.csv")

df_2019 = pd.DataFrame(rows_2019)
df_2019.to_csv("assets/firearms_2019.csv")
